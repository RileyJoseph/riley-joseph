    ...
    <div className="min-h-screen p-8 flex flex-col app-body all">
      ...
      <div id="bio" className="bio flex flex-col md:flex-row ">
        ...
        <div className="info flex-1 p-4 md:pl-16 text-center md:text-left">
          ...
          <div className='buttons pt-8 mobile-center'>
            <a className='btn btn-white' href="https://coattheband.bandcamp.com/" target="_blank">Coat</a>
            <a className='btn btn-white ml-1' href="https://www.instagram.com/lovergirltheband/?hl=en">Lover Girl</a>
            <br />
            <br />
            <a className='btn btn-white mt-4' target="_blank" href="https://goodthebad.bandcamp.com/album/temporary-spaces">Temporary Spaces</a>
          </div>
        </div>
