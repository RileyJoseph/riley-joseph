    ...
    <div className="navbar p-4">
      <nav className="flex justify-between items-center w-full">
        <div className="flex gap-4">          
          ...
          <Link to="/" className="anti-btn py-2 ">Home</Link>   
          {/* <Link to="/portfolio" className="anti-btn py-2 ">Portfolio</Link>        */}
          {/* <Link to="/vapor-lounge" className="px-4 py-2 bg-purple-500 text-white rounded hover:bg-purple-600">Vapor Lounge</Link> */}
        </div>

        {/* Color Picker Dropdown */}
        <div className="relative">
          <button className="dropdown px-4 py-2 text-white rounded" onClick={() => setIsDropdownOpen(!isDropdownOpen)}>Menu</button>
          {isDropdownOpen && (
            <ul className="absolute mt-2 shadow-lg rounded bg-transparent">

              <li><Link to="/" className="anti-btn py-2 ">Home</Link>   </li>
              <li><Link to="/portfolio" className="anti-btn py-2 ">Portfolio</Link>   </li>
              {/* <li><Link to="/" className="anti-btn py-2 ">Music</Link>   </li> */}
              <li><Link to="/bio" className="anti-btn py-2 ">About Me</Link>   </li>
              {/* <li className="">
